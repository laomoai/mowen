  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        order_field: { type: "string", description: "id、日期或日期时间字段" },
        order_direction: { type: "string", enum: ["asc", "desc"], description: "默认 asc" },
      },
...
function runningBalanceConfig(args) {
  return {
    ...
    order_direction: args.order_direction === "desc" ? "desc" : "asc",
    tie_breaker: "id",
    null_as_zero: true,
    precision: 2,
  };
